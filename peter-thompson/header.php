	...
	<div class="navbar-area py-0">
		<div class="main-nav">
			<div class="bigger-container spr position-relative g-0">
				...
				<div class="formstyle">
					<form role="search" method="get" class="subscribe-form" action="<?= ICL_LANGUAGE_CODE === 'en' ? '/home-tours/' : '/fr/home-tours/' ?>">
						...
						<input type="submit" class="btn-default" value="<?php echo esc_attr_x( 'Search', 'submit button' ) ?>" />
					</form>
				</div>
			</div>
		</div>
